...
const perguntarAI = async (question, game, apiKey) => {
  ...
  `
    ...
    // A estrutura é baseada no modelo Gemini 2.0 Flash
    // https://developers.generativeai.google/learn/api/gemini-2-0-flash
...
const enviarFormulario = async (event) => {
    ...
    try {
        ...
        aiResponse.classList.remove('hidden') // Show the response section
    } catch (error) {
